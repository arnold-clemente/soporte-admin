<template>
  <AppLayout>
    ...
    <div class="w-full flex items-center justify-end px-6">
      ...
      >
        <Link :href="route('almacen.create')" class="flex items-center">
      ...
      >
        ...
        <tbody>
          <tr v-for="almacen in almacenes" :key="almacen.id">
            <td>
              <Link
                :href="route('almacenes.index', almacen.id)"
            ...
            <td>
              {{
                almacen.funcionario.nombres +
                " " +
                almacen.funcionario.apellidos
              }}
            </td>
            <td>{{ almacen.nota.cite }}</td>
          </tr>
        </tbody>
      </table>
    </div>
