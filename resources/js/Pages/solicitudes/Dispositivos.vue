                ...
                <div class="sm:col-span-3">
                  <div>
                    <input
                      ...
                      v-model="falencia"
                      autocomplete="codigo"
                      placeholder="Falencia del dispositivo"
  ...
  methods: {
    ...
    create() {
      ...
      if (
        ...
        this.falencia !== "" &&
        this.falencia.length < 200
      ) {
        if (this.addeds.length > 0) {
          var found = this.addeds.find((e) => e.dispositivo_id === this.dispositivo_id);
          if (found === undefined) {
            const dispositivo = {
              id: this.dispositivo_id,
              codigo: this.codigo,
              nombre: this.nombre,
              falencia: this.falencia,
              soporte_id: null,
          ...
          this.$emit("createDispositivo", dispositivo);
          (this.dispositivo_id = null), (this.dispositivo_id = null);
          this.codigo = "";
          this.nombre = "";
          this.falencia = "";
          this.soporte_id = null;
      ...
      setTimeout(() => (this.error.falencia = ""), 2000);
