<template>
  <AppLayout>
    ...
    <div class="w-full flex items-center justify-end px-6">
      ...
      >
        <Link :href="route('devolucion.create')" class="flex items-center">
    ...
    <div class="table-resposive px-6">
      ...
      >
        ...
        <tbody>
          <tr v-for="devolucion in devolucions" :key="devolucion.id">
            <td>
              <Link
                :href="route('devolucions.index', devolucion.id)"
            ...
            <td>
              {{
                devolucion.funcionario.nombres +
                " " +
                devolucion.funcionario.apellidos
              }}
            </td>
            <td>{{ devolucion.nota.cite }}</td>
          </tr>
        </tbody>
      </table>
    </div>
