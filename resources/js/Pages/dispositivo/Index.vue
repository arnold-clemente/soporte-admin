<template>
  <AppLayout>
    ...
    <div class="w-full flex items-center justify-end px-6">
      ...
      >
        <Link :href="route('dispositivo.create')" class="flex items-center">
      ...
      >
        ...
        <tbody>
          <tr v-for="dispositivo in dispositivos" :key="dispositivo.id">
            ...
            <td>{{ dispositivo.tamano }}</td>
            <td>
              {{
                dispositivo.tecnico.nombres +
                " " +
                dispositivo.tecnico.apellidos
              }}
            </td>
          </tr>
        </tbody>
    ...
    destroy($dispositivo) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          axios
            .delete(route("dispositivo.destroy", $dispositivo))
            .then((response) => {
              Swal.fire({
                position: "center",
                icon: "success",
