        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr v-for="dispositivo in dispositivos" :key="dispositivo.id"
                    ...
                    <td class="px-6 py-4 w-12">
                        <span>{{ dispositivo.solucion }}</span>
                    </td>
                    <td class="px-6 py-4 w-12">
                        <span>{{ dispositivo.estado }}</span>
                    </td>
                    <td class="px-6 py-4 text-white">
                        <div class="flex items-center justify-center space-x-1">
                    ...
                    <div class="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6 content-start justify-self-start">
                        <div class="sm:col-span-6 flex flex-col">
                            ...
                            <div>
                                <div class="sm:col-span-3">
                                    <div>
                                        <input disabled type="text" v-model="equipo.falencia" autocomplete="codigo"
                                            placeholder="Falencia del Equipo"
                                            class="block h-12 w-full bg-gray-200 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                    </div>
                                </div>
                            </div>
                            <label class="block text-sm font-medium leading-6 text-gray-900">Solución:</label>
                            <div>
                                <div class="sm:col-span-3">
                                    <div>
                                        <input type="text" v-model="equipo.solucion" placeholder="Solucion del Equipo"
                            ...
                            <div>
                                <div class="sm:col-span-3">
                                    <div>
                                        <input disabled type="text" v-model="equipo.estado" placeholder="Estado del Equipo"
                                            class="block h-12 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                    </div>
                                    <ul class="mt-3 list-dick list-inside text-sm text-red-600">
                                        <li>{{ error.estado }}</li>
                    ...
                    <div class="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6 content-start justify-self-start">
                        <div class="sm:col-span-6 flex flex-col">
                            ...
                            <div>
                                <div class="sm:col-span-3">
                                    <div>
                                        <input disabled type="text" v-model="dispositivo.falencia" autocomplete="codigo"
                                            placeholder="Falencia del Equipo"
                                            class="block h-12 w-full bg-gray-200 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                    </div>
                                </div>
                            ...
                            <div>
                                <div class="sm:col-span-3">
                                    <div>
                                        <input type="text" v-model="dispositivo.solucion" placeholder="Solucion del Equipo"
                                            class="block h-12 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                    </div>
                                    <ul class="mt-3 list-dick list-inside text-sm text-red-600">
                                        <li>{{ error.solucion }}</li>
                            ...
                            <div>
                                <div class="sm:col-span-3">
                                    <div>
                                        <input disabled type="text" v-model="dispositivo.estado"
...
export default {
    ...
    emits: ["updateEquipo", "updateDispositivo"],
    methods: {
        setModalEquipo($equipo) {
            ...
            this.equipo.solucion = $equipo.solucion;
        ...
        updateEquipo() {
            ...
            if (this.equipo.solucion === null) {
                this.error.solucion = "El campo es requerido";
            } else {
                if (this.equipo.solucion === "") {
                    this.error.solucion = "El campo es requerido";
                }
                if (this.equipo.solucion.length > 200) {
                    this.error.solucion = "El texto de demasiado largo";
                }
            }
            if (this.equipo.solucion !== null) {
                if (this.equipo.solucion !== "" && this.equipo.solucion.length < 200) {
            ...
            setTimeout(() => (this.error = rehacer), 2000);
        },
        ...
        setModalDispositivoo($dispositivo) {
            ...
            // this.dispositivo.estado = $dispositivo.estado;
            this.dispositivo.solucion = $dispositivo.solucion;
        ...
        updateDispositivo() {
            ...
            if (this.dispositivo.solucion === null) {
                this.error.solucion = "El campo es requerido";
            } else {
                if (this.dispositivo.solucion === "") {
                    this.error.solucion = "El campo es requerido";
                }
                if (this.dispositivo.solucion.length > 200) {
                    this.error.solucion = "El texto de demasiado largo";
                }
            }
            if (this.dispositivo.solucion !== null) {
                if (this.dispositivo.solucion !== "" && this.dispositivo.solucion.length < 200 && this.dispositivo.estado !== "" && this.dispositivo.estado.length < 200) {
                    this.procesoAgregar = true;
