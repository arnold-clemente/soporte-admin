  ...
  <AppLayout>
    ...
    <div class="w-full flex items-center justify-end px-6">
      <div class="ml-4 px-4 py-2 bg-red-700 hover:bg-red-600 transition-all rounded-md text-white font-bold">
        <Link :href="route('ingreso.create')" class="flex items-center">
      ...
      <table class="table table-hover table-bordered table-striped" id="sampleTable">
        ...
        <tbody>
          <tr v-for="ingreso in ingresos" :key="ingreso.id">
            <td>
              <a :href="route('ingreso.reporte', ingreso)" target="_blank"
            ...
            <td>{{ ingreso.tecnico.nombres + " " + ingreso.tecnico.apellidos }}</td>
          </tr>
        </tbody>
      </table>
    </div>
